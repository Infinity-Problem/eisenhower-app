...
**Windows** — Download `Eisenhower.exe` from the [latest release](../../releases) and double-click. No installer, no dependencies, no admin rights. Tasks live in `%APPDATA%\Eisenhower\tasks.json`.
